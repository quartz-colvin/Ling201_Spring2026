...
- The happy dog ran quickly.

Let's try some tests:

- The dog who ran quickly was happy. (movement)

- How was the dog who ran quickly? Happy! (stand alone)

- How did the happy dog run? Quickly! (stand alone)

- The happy dog ran like that. (replacement)
...
Now we're going to learn two more phrase types so that we can build up to entire sentences:


- Verb Phrase (VP)

- Tense Phrase (TP), aka Sentence
...
- Indirect object (IO) – person or entity that receives something or benefits from the action. Indirect objects can be PPs or NPs:

  - Peter baked **[a cake]** [for his mother]

  - Peter baked [his mother] **[a cake]**
...
**Sentences** are also known as **tense phrases** (**TP**, or occasionally S). They consist of:
