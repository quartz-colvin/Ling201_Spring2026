...
.pull-right[
- Venn diagrams are especially useful for illustrating where sets
**overlap** (what members they have in common):
...
2. squirrel vs. mammal

3. sparrow vs. bird

4. soft drink vs. soda
...
**Synonyms** have the same set of referents: *drink* and *beverage* refer to the same set of things
...
- The reference of a **hyponym** is a **proper subset** of the reference of its **hypernym**
...
[[Snoopy]] ∈ [[cat]] ...<span style="color:red">FALSE!</span>

[[cat]] ⊆ [[bark]] ...<span style="color:red">FALSE!</span>

[[cat]] ⊆ [[mammal]] ...<span style="color:green">TRUE!</span>
...
- <u>Tip</u>: the symbol for union (∪) looks like the letter "U"
...
Complement of A produces a new set, which contains all elements in the specified universe (U) that are not in A
...
# Coming Up! **Semantics: practicing set theory**
