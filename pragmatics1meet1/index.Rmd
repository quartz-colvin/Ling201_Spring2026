...
--
  ...
  - Literal meaning (of the example): *Person B has an exam*
...
--
  ...
  - Implied meaning (of the example): *Person B can't or doesn't want to go out*
...
--
  ...
  - But, in Arkansas (and probably other southern rural areas) they still enforce children calling their teachers and other adults *sir* and *ma'am* because it's more respectful
...
- *Apollo is not a husky*
  ...
  - It no longer entails *Apollo is a dog* – <span style="color:green">truth values have changed</span>

  - But, it still presupposes *Apollo exists* – <span style="color:green">presuppositions don't rely on truth values</span>
]
...
- Presupposes *England has a King*, it's in our common ground, makes sense <span style="color:green">✓</span>
...
knitr::include_graphics("./images/AG.jpeg")
```
