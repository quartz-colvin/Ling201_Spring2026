...
### Discuss what these mean in groups.
...
**[Q.]** Are the following word pairs *synonyms, antonyms,* or a *hypernym-hyponym* pair?
...
**[Q.]** For each pair of sentences, does the first sentence **(a)** entail the second sentence **(b)**?
...
# <span style="color:blue">Mutual entailment</span>
...
# <span style="color:green">Let's go over the midterm</span>

## *(<u>Reminder</u>: the final will not cover the material before the midterm)*

---

# Summary

<span style="color:blue"><u>Semantics</u></span>: literal meaning

- <span style="color:green"><u>Lexical semantics</u></span>: conventional and arbitrary

- <span style="color:green"><u>Compositional semantics</u></span>: Meaning of words + Meaning of structure = Meaning of a sentence

--

<span style="color:blue"><u>Pragmatics</u></span>: implied meaning

--

<span style="color:blue"><u>Semantic relations</u></span>: synonym, antonym, hypernym (SUPERSET of...), hyponym (subset of...)

--

<span style="color:blue"><u>Entailment</u></span>: sentence p entails q iff q is true whenever p is true

- <span style="color:green"><u>Example</u></span>: *p*: <u>Quartz is a linguistics student</u> **entails** *q* <u>Quartz is a student</u>
...
- I will post **HW4** by March 8, and it will be due <u>March 15</u>
