...
As we’ve seen, all consonants are produced with some obstruction.
...
Then you release the closure, causing a small burst or explosion of pressurized air – hence "plosive"
...
- **Voiceless stops** [p, t, k]: *spin* [spɪn], *stop* [stɑp], *scar* [skɑɹ]

--

- **Voiced stops** [b, d, g]: *about* [əbawt], *adore* [ədɔɹ], *ago* [əgow]

--

- English voiceless stops are often **aspirated** – pronounced with a short [h] sound after the release: *tip* [tʰɪp], *pen* [pʰɛn], *cat* [kʰæt]
...
We produce most consonants by breathing out our mouth. But with **nasal** consonants, we’re actually breathing our our nose.

--

We do this by making a complete obstruction in the mouth, and lowering our **velum** or soft palate, allowing air to pass through the velar port into the **nasal cavity**.

--

English nasals: [m, n, ŋ]: *mat* [mæt], *nine* [najn], *sing* [sɪŋ]
...
.pull-left[
Before we talk about place of articulation, we have to discuss a bit of anatomy.
...
- Through the pharynx (open space behind tongue).
...
.pull-left[
**Retroflexes** are articulated with the tongue tip arched backward.

American English *r* may be pronounced as retroflex, but it depends on the speaker.
...
.pull-left[
**Palatals** are produced with the tongue body raised against the hard palate
...
Consonants are sounds that feature some **obstruction of airflow**.
...
**(1) Identify which consonants are in the following words, (2) give the IPA symbol for them, and (3) define them using the three features.**
...
- HW7 will be posted **by** April 12
